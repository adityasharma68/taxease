  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <h3 className="font-bold text-slate-900 mb-4">Filing Status Breakdown</h3>
              ...
              {[
                ...
                <div key={s.label}>
                  <div className="flex justify-between text-sm mb-1.5">
                    ...
                    <span className="text-slate-500">{s.count} / {filings.length || 1}</span>
                  </div>
          ...
          <div className="mt-6 grid grid-cols-4 gap-2">
            {[{label:"GST",val:gstCount},{label:"ITR",val:itrCount},{label:"TDS",val:tdsCount},{label:"Other",val:otherCount}].map(t => (
              <div key={t.label} className="bg-slate-50 rounded-xl p-2.5 text-center">
                <div className="text-lg font-black text-slate-900">{t.val}</div>
      ...
      <Card>
        <div className="px-5 py-4 border-b border-slate-100 flex items-center gap-2">
          ...
          <h3 className="font-bold text-slate-900">Delay Report — Overdue Filings</h3>
                ...
                {overdueFilings.map(f => {
                  ...
                  return (
                    <tr key={f._id} className="hover:bg-red-50/30">
                      <td className="px-4 py-3 text-sm font-semibold text-slate-900">{f.client?.name || "—"}</td>
                      <td className="px-4 py-3 text-sm text-slate-700">{f.type}</td>
                      <td className="px-4 py-3 text-sm text-slate-600">{f.period}</td>
      ...
      <Card>
        <div className="px-5 py-4 border-b border-slate-100 flex items-center gap-2">
          ...
          <h3 className="font-bold text-slate-900">Clients Without Document Uploads</h3>
